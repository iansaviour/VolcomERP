Public Class FormViewMatAdjIn 
    ...
    Sub viewDetailReturn()
        Dim query As String = ""
        If action = "ins" Then
            query = "SELECT ('0') AS id_adj_in_mat_det, "
            query += "('0') AS id_mat_det, ('0') AS id_wh_drawer, "
            query += "CAST('0' AS DECIMAL(13,2)) AS adj_in_mat_det_qty, CAST('0' AS DECIMAL(13,2)) AS adj_in_mat_det_amount, "
            query += "CAST('0' AS DECIMAL(13,2)) AS adj_in_mat_det_price, "
            query += "CAST('0' AS DECIMAL(13,2)) AS adj_in_mat_det_kurs, "
            query += "('') AS name, "
            query += "('') AS code, "
            query += "('') AS size, "
            query += "('') AS uom, "
            query += "('') AS adj_in_mat_det_note, "
