...
Public Class ReportSampleReturnIn
    Public Shared id_sample_purc_ret_in As String
    ...
    Private Sub ReportSampleReturnIn_BeforePrint(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        Try
            ...
            LabelNo.Text = data.Rows(0)("sample_purc_ret_in_number").ToString
            LabelNote.Text = data.Rows(0)("sample_purc_ret_in_note").ToString
            ...
            viewDetailReturn()
            load_mark_horz("6", id_sample_purc_ret_in, "2", "1", XrTable1)
