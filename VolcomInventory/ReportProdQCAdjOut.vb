...
Public Class ReportProdQCAdjOut
    Public Shared id_adj_out As String = "-1"
    ...
    Sub view_adj_in()
        ...
        Dim datex As Date = data.Rows(0)("prod_order_qc_adj_out_date")

        LNumber.Text = data.Rows(0)("prod_order_qc_adj_out_number").ToString
        LDate.Text = "DATE : " + datex.ToString("dd MMM yyyy")
        LNote.Text = data.Rows(0)("prod_order_qc_adj_out_note").ToString
    ...
    Private Sub ReportSamplePR_BeforePrint(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        load_mark_horz("73", id_adj_out, "2", "1", XrTable1)
    End Sub
