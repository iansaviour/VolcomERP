Public Class FormFGMissingCreditNoteStoreDet 
    ...
    Private Sub FormFGMissingCreditNoteStoreDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FormFGMissingCreditNoteStoreDet_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Dispose()
    End Sub
    ...
    Sub allow_status()
        If check_edit_report_status(id_report_status, "67", id_sales_pos) Then
        ...
        If check_attach_report_status(id_report_status, "67", id_sales_pos) Then
    ...
    Private Sub BtnBrowseContactFrom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBrowseContactFrom.Click
        ...
        FormSalesCreditNotePopInv.id_pop_up = "2"
            ...
            If action = "ins" Then
                ...
                If confirm = Windows.Forms.DialogResult.Yes Then
                    ...
                    Try
                        ...
                        query += "VALUES('" + id_sales_pos_ref + "','" + id_store_contact_from + "', '" + sales_pos_number + "', NOW(), '" + sales_pos_note + "', '" + id_report_status + "', '" + id_so_type + "', '" + decimalSQL(total_amount.ToString) + "', '" + sales_pos_due_date + "', '" + sales_pos_start_period + "', '" + sales_pos_end_period + "', '" + sales_pos_discount + "', '" + sales_pos_vat + "', '4'); SELECT LAST_INSERT_ID(); "
                        id_sales_pos = execute_query(query, 0, True, "", "", "", "")

                        increase_inc_sales("18")

                        'insert who prepared
                        insert_who_prepared("67", id_sales_pos, id_user)
                        ...
                        FormFGMissingCreditNote.GVFGMissingCNStore.FocusedRowHandle = find_row(FormFGMissingCreditNote.GVFGMissingCNStore, "id_sales_pos", id_sales_pos)
                        Close()
                    Catch ex As Exception
                        errorConnection()
                        Close()
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        Cursor = Cursors.WaitCursor
        ReportFGMissingCreditNoteStore.id_sales_pos = id_sales_pos
        ReportFGMissingCreditNoteStore.dt = GCItemList.DataSource
        Dim Report As New ReportFGMissingCreditNoteStore()
