Public Class ReportMasterPriceSample
    Public Shared dt As New DataTable
    Public Shared id_sample_price As String = "-1"
    ...
    Private Sub ReportMasterPrice_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
        ...
        If id_pre = "-1" Then
            load_mark_horz("86", id_sample_price, "2", "1", XrTable1)
        Else
            pre_load_mark_horz("86", id_sample_price, "2", "2", XrTable1)
        End If
    End Sub
