Public Class FormFGMissingInvoiceNew 
    Dim id_store_contact_to_default As String = "0"

    Private Sub FormFGMissingInvoiceNew_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'view data
        viewStore()
    ...
    Private Sub FormFGMissingInvoiceNew_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Dispose()
    End Sub
    ...
    Private Sub BtnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCreate.Click
        ...
        FormFGMissingInvoiceDet.id_store_contact_to = SLEStore.EditValue.ToString
        FormFGMissingInvoiceDet.TxtCodeCompTo.Text = SLEStore.Properties.View.GetFocusedRowCellValue("comp_number").ToString
        FormFGMissingInvoiceDet.TxtNameCompTo.Text = SLEStore.Properties.View.GetFocusedRowCellValue("comp_name").ToString
        FormFGMissingInvoiceDet.MEAdrressCompTo.Text = SLEStore.Properties.View.GetFocusedRowCellValue("address_primary").ToString
        FormFGMissingInvoiceDet.DEStart.EditValue = DEStart.EditValue.ToString
        FormFGMissingInvoiceDet.DEStart.Text = DEStart.Text.ToString
        FormFGMissingInvoiceDet.DEEnd.EditValue = DEEnd.EditValue.ToString
        FormFGMissingInvoiceDet.DEEnd.Text = DEEnd.Text.ToString
        FormFGMissingInvoiceDet.action = "ins"
        Visible = False
        Close()
