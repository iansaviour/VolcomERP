Public Class FormFGMissingDet 
    ...
    Sub actionLoad()
        If action = "ins" Then
            ...
            If id_pop_up = "1" Then
                TxtFGMissingNumber.Text = header_number_sales("10")
    ...
    Sub viewStockStore()
        ...
        End Try
        Dim query As String = "CALL view_stock_fg('" + id_store_from + "', '" + id_wh_locator + "', '" + id_wh_rack + "', '" + id_wh_drawer + "', '0', '4', '" + end_period + "') "
    ...
    Sub allow_status()
        If check_edit_report_status(id_report_status, "54", id_fg_missing) Then
        ...
        If check_attach_report_status(id_report_status, "54", id_fg_missing) Then
    ...
    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        ...
        FormFGMissingSingle.id_wh_locator = id_wh_locator
        FormFGMissingSingle.id_wh_rack = id_wh_rack
        FormFGMissingSingle.id_wh_drawer = id_wh_drawer
        Dim end_period As String = "9999-01-01"
        Try
            end_period = DateTime.Parse(DEEnd.EditValue.ToString).ToString("yyyy-MM-dd")
        Catch ex As Exception
        End Try
        FormFGMissingSingle.date_param = end_period
            ...
            If action = "ins" Then
                ...
                If confirm = Windows.Forms.DialogResult.Yes Then
                    ...
                    Try
                        ...
                        'insert who prepared
                        insert_who_prepared("54", id_fg_missing, id_user)
                        ...
                        rsv_stock.reservedStock(id_fg_missing, "54")
