Public Class FormFGTrfReceive 
    Dim bnew_active As String = "1"
    Dim bedit_active As String = "1"
    Dim bdel_active As String = "1"

    Private Sub FormFGTrfReceive_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        viewFGTrf()
    End Sub
    ...
    Sub viewFGTrf()
        Dim query As String = ""
        query += "SELECT "
        query += "trf.id_fg_trf, trf.fg_trf_number, (trf.fg_trf_date) AS fg_trf_date, trf.fg_trf_note, trf.id_report_status, trf.id_report_status_rec,IF(ISNULL(trf.id_report_status_rec), '-', rep_status.report_status) AS report_status, "
    ...
    Private Sub FormFGTrfReceive_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        FormMain.show_rb(Name)
        check_menu()
    End Sub

    Private Sub FormFGTrfReceive_Deactivate(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Deactivate
        FormMain.hide_rb()
    End Sub
