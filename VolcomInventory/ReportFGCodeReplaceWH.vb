Public Class ReportFGCodeReplaceWH
    Public Shared dt As DataTable
    Public Shared id_report As String = "-1"

    Private Sub ReportFGCodeReplaceWH_BeforePrint(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
        GridControl1.DataSource = dt
        'mark
        load_mark_horz("68", id_report, "2", "1", XrTable1)
    End Sub
